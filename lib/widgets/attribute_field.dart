        ...
        children: [
          ...
          Expanded(
            child: DropdownButtonFormField<String>(
              initialValue: attributeTypeController.text.isNotEmpty && dataTypes.contains(attributeTypeController.text.toLowerCase()) ? attributeTypeController.text.toLowerCase() : defaultValue,
